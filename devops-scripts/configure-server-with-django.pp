...
package { ['git', 'nginx', 'postgresql', 'postgresql-contrib']:
  ensure => installed,
}

# Clone Django project from GitHub
$git_repo_url = 'https://github.com/ShymaaIsmail/kid-coder-carnival.git'
$base_directory = $facts['home']
$project_directory = '$base_directory/kid-coder-carnival/kid-coder-carnival-api/kidcodercarnivalapi'
